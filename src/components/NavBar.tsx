...
const navigation = [
    ...
    { title: 'asesorias', path: '/asesoria', current: false },
    { title: 'plantas', path: '/plantas', current: false },
    { title: 'insumos', path: '/insumos', current: false },
    { title: 'contacto', path: '/contacto', current: false },
...
export const NavBar = () => {
    ...
    return (
        <nav  className="top-0 left-0 right-0 z-10 bg-white  w-full shadow-xl opacity-90 mx-auto">
